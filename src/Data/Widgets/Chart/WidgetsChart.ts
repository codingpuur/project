    ...
    xaxis: [
      {
        ...
        label: {
          ...
          style: {
            color: "#fff",
            background: ConfigDB.data.color.primary_color,
          },
          text: "Anno Test",
        },
      },
...
export var orderStatusChart:ApexOptions = {
  ...
  colors: [ConfigDB.data.color.primary_color, "#ff6150" ],
  markers: {
    size: 0,
    hover: {
      size: 0,
...
export var progressChart2:ApexOptions = {
  chart: {
    height: 70,
    type: "bar",
    stacked: true,
